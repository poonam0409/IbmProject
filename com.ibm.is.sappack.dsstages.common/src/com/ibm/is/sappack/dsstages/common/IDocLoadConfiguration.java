...
public interface IDocLoadConfiguration {

	static final String IBM_COPYRIGHT_SHORT = Copyright.IBM_COPYRIGHT_SHORT;
	
	String getLoadDataDirectory();
	
	String getConnectionPartnerNumber();
	
	String getSAPPartnerNumber();
	
	String getFileBasedLoadDirectory();
