...
public interface Constants {
	...
	// The help IDs
	public static final String HELP_ID_SELECT_SAP_SYSTEM = Constants.PLUGIN_ID + ".select_sap_system"; //$NON-NLS-1$
	public static final String HELP_ID_SELECT_BUSINESS_OBJECTS = Constants.PLUGIN_ID + ".select_business_objects"; //$NON-NLS-1$
	public static final String HELP_ID_BROWSE_SAP_SYSTEM = Constants.PLUGIN_ID + ".browse_sap_system"; //$NON-NLS-1$
	public static final String HELP_ID_SPECIFY_TABLES_MANUALLY = Constants.PLUGIN_ID + ".specify_tables_manually"; //$NON-NLS-1$
	public static final String HELP_ID_SPECIFY_IDOCS_MANUALLY = Constants.PLUGIN_ID + ".specify_idocs_manually"; //$NON-NLS-1$
	public static final String HELP_ID_IMPORT_OPTIONS = Constants.PLUGIN_ID + ".import_options"; //$NON-NLS-1$
	public static final String HELP_ID_IDOC_IMPORT_OPTIONS = Constants.PLUGIN_ID + ".idoc_import_options"; //$NON-NLS-1$
	public static final String HELP_ID_TABLE_LIST = Constants.PLUGIN_ID + ".tables_list"; //$NON-NLS-1$
	public static final String HELP_ID_SAP_SYSTEM = Constants.PLUGIN_ID + ".sap_system"; //$NON-NLS-1$
	public static final String HELP_ID_TECHNICAL_FIELDS = Constants.PLUGIN_ID + ".technical_fields"; //$NON-NLS-1$	
	public static final String HELP_ID_SEGMENT_LIST = Constants.PLUGIN_ID + ".segment_list"; //$NON-NLS-1$
	public static final String HELP_ID_BROWSE_SAP_SYSTEM_FOR_IDOCS = Constants.PLUGIN_ID
			+ ".browse_sap_system_for_idocs"; //$NON-NLS-1$
	public static final String HELP_ID_SELECT_LDM_PACKAGE = Constants.PLUGIN_ID + ".select_ldm_package"; //$NON-NLS-1$
	public static final String HELP_ID_IMPORT_SUMMARY = Constants.PLUGIN_ID + ".import_summary"; //$NON-NLS-1$

	// replay wizard
	public static final String HELP_ID_REEXTRACT_DISPLAY_RUNS = Constants.PLUGIN_ID + ".reextract_display_runs"; //$NON-NLS-1$
	public static final String HELP_ID_REEXTRACT_OPTIONS = Constants.PLUGIN_ID + ".reextract_options"; //$NON-NLS-1$

	// Empty String
	public final String EMPTY_STRING = ""; //$NON-NLS-1$
	public final String BLANK = " "; //$NON-NLS-1$
	public final String HASH = "#"; //$NON-NLS-1$
