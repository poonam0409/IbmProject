...
//                                                                             
// Module Name : com.ibm.is.sappack.gen.server.datastage_v8
//                                                                             
//*************************-END OF SPECIFICATIONS-***************************
package com.ibm.is.sappack.gen.server.datastage_v8;


import java.io.File;
import java.rmi.RemoteException;

import com.ascential.acs.security.auth.AuthorizationService;
import com.ascential.acs.security.auth.AuthorizationServiceFactory;
import com.ascential.acs.security.directory.DataStageCredential;
import com.ascential.asb.util.security.DSEncryption;
import com.ascential.ds4j.HostNotRespondingException;
import com.ascential.ds4j.Project;
import com.ascential.ds4j.ProjectOpenFailedException;
import com.ascential.ds4j.Server;
import com.ascential.ds4j.SessionConnectException;
import com.ascential.ds4j.SessionDisconnectException;
import com.ascential.ds4j.SessionNotConnectedError;
import com.ascential.ds4j.SubroutineCallException;
import com.ascential.ds4j.impl.ServerImpl;
...
public class UVAccessor {
   ...
   private DSProject dsProject = null;
	...
	static String copyright() {
		return com.ibm.is.sappack.gen.server.datastage_v8.Copyright.IBM_COPYRIGHT_SHORT;
	}
   ...
   public UVAccessor(DSProject dsProject) {
	...
	public DataStageCredential getCredentials() throws RemoteException, DSAccessException {
		DataStageCredential         dsCredentials;
		...
		try {
			// get authorization to universe repository.
			authorizationServiceFactory = new AuthorizationServiceFactory(new com.ascential.acs.security.auth.DefaultConfiguration());
			authorizationService        = authorizationServiceFactory.getImplementation();
