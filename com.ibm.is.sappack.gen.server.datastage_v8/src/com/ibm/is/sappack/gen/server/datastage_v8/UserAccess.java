   ...
   */
   ...
   {        
   	...
   	try
      {
           ...
           m_authorizationService = authorizationServiceFactory.getImplementation();
      }         
   	catch (Exception e)
   	{
    ...
    * @throws SessionExpiredException
    */
	private int getDSUserRole() throws RemoteException, SessionExpiredException
	{
     ...
     * @throws RemoteException
     */
	private int getDSProjectUserRole(String hostName, String project) throws RemoteException, SessionExpiredException
	{
		int role = DSR_UROLE_NONE;
