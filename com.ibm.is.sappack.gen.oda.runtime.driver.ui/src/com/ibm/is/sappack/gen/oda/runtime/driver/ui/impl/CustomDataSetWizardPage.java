...
package com.ibm.is.sappack.gen.oda.runtime.driver.ui.impl;
...
public class CustomDataSetWizardPage extends DataSetWizardPage
{
    ...
    private static String DEFAULT_MESSAGE = Messages.CustomDataSetWizardPage_0;
    
    private transient Text m_queryTextField;
    
	static String copyright()
    { return com.ibm.is.sappack.gen.oda.runtime.driver.ui.impl.Copyright.IBM_COPYRIGHT_SHORT; }
    ...
    private Control createPageControl( Composite parent )
    {
        ...
        fieldLabel.setText( Messages.CustomDataSetWizardPage_1 );
	...
	private void validateData( )
	{
        ...
        if( isValid )
            ...
            setMessage( Messages.CustomDataSetWizardPage_2, ERROR );
	...
	private void savePage( DataSetDesign dataSetDesign )
	{
        ...
        try
        {
             ...
             */
            IDriver customDriver = new com.ibm.is.sappack.gen.oda.runtime.driver.impl.Driver();
...
//      query.executeQuery();
        ...
        throws OdaException
    {
        ...
        if( paramDesign.getParameterDefinitions().size() > 0 )
        {
            ...
            if( paramDef != null )
                paramDef.setDefaultScalarValue( Messages.CustomDataSetWizardPage_3 );
        }
    }
